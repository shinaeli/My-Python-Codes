...
print(f"I'm inviting {len(guest_list)} people for a dinner.") #3
...
print(f"I'm inviting {len(guest_list)} people for a dinner.") #6
...
print(f"I'm inviting {len(guest_list)} people for a dinner.") #2
